    ...
    module.controller("checkoutController", ["$rootScope", "$scope", "checkoutService", "cart", "labelService", "moltin", function ($rootScope, $scope, checkoutService, cart, labelService, moltin) {
        ...
        vm.checkout = function(data) {
            moltin.Cart().Checkout(data, {
                ...
                var form = '<form action="https://securegw.paytm.in/theia/processTransaction" method="POST"><div><input name="REQUEST_TYPE" type="text" type="hidden" value="DEFAULT"/><input name="MID" type="text" type="hidden" value="Pentag46972444763247"/><input name="ORDER_ID" type="text" type="hidden" value="' + order.data.id + '"/><input name="CUST_ID" type="text" type="hidden" value="' + order.data.customer.id + '"/><input name="TXN_AMOUNT" type="text" type="hidden" value="' + vm.getCartTotal() + '"/><input name="CHANNEL_ID" type="text" type="hidden" value="WEB"/><input name="INDUSTRY_TYPE_ID" type="text" type="hidden" value="Retail109"/><input name="WEBSITE" type="text" type="hidden" value="PentagWEB"/><input name="CALLBACK_URL" type="text" type="hidden" value="https://www.youngandenergetic.com:7000/payment"/></div></form>';
